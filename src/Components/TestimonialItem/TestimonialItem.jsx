...
const TestimonialItem = ({ review }) => {
  const {id,reviewText,clientName,clientLocation,clientImage,testimonialImage,videoUrl} = review;
  return (
    <>
      <div className="row g-0 d-flex flex-xl-row flex-column-reverse">
        <div className="col-xl-5 p-5 position-relative client-content">
          ...
          <img src={star} alt="Star Image" className="position-absolute start-0 half-star" />
        </div>
        <div className="col-xl-7 position-relative">
          <div className="client-video overflow-hidden">
            <div className="video-wrapper position-relative">
              <Link to="#" className="w-100" data-bs-toggle="modal" data-bs-target={`#${id}`}>
                <img src={testimonialImage} alt="Tesimonial Image" className="w-100 img-fluid" />
